...
public class MediaHandler
{
    public static BufferedImage imageLogo, imageTitle, imageAdd, imageAddOn, imageList, imageListOn, imageTest, imageTestOn,
            ...
            imageContinue, imageContinueHL, imageCancel, imageCancelHL, imageSync, imageSyncHL,
    ...
    static
    {
        try
        {
            ...
            imageSync = ImageIO.read(getImage("image_sync.png"));
            imageSyncHL = ImageIO.read(getImage("image_sync_hl.png"));
